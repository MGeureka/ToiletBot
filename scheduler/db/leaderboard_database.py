...
from bot.utils.database_helper import (get_valorant_profiles, executemany_commit,
                                       get_datetime,
...
from scheduler.api.val_api import fetch_rating, fetch_dms
from scheduler.api.kovaaks_api import (get_s5_novice_benchmark_scores,
                                       get_s5_intermediate_benchmark_scores,
                                       get_s5_advance_benchmark_scores)
from scheduler.api.aimlabs_api import fetch_user_plays
from bot.settings import (S1_VOLTAIC_VAL_BENCHMARKS_CONFIG,
...
if __name__ == "__main__":
    import asyncio
    from scheduler.api.aimlabs_api import setup, teardown
