...
from settings import DISCORD_API_SECRET, DSN, REDIS_URL
...
async def setup_hook():
    bot.db = Database(DSN, max_pool_size=8, min_pool_size=2)
    await bot.db.start_pool()
